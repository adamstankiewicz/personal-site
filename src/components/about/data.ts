...
export const aboutParagraphs = [
  "The work has always split two ways — usually both at once. The day job is shipping features on a product team; running alongside it, I’m building the design system, the design tokens, and the accessibility tooling that team builds with.",
  "I started out in research. A video learning platform I built as an undergrad turned into published papers and two years of a Ph.D. at Carnegie Mellon before I traded the lab for industry. Seven years at [edX](https://edx.org) / [2U](https://2u.com) came first, leading [Paragon](https://paragon-openedx-v22.netlify.app) for the [Open edX](https://openedx.org) ecosystem while building edX for Business. Now it’s [MagicSchool AI](https://magicschool.ai), where that same split has taken on a new shape: teaching AI coding agents, not just engineers, to respect a design system. The research years still show up: I’d rather run an evaluation than argue from taste.",
];
