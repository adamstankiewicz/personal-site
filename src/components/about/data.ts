...
export const aboutParagraphs = [
  "The day job is shipping features on a product team; running alongside it, I’m building the design system, the design tokens, and the accessibility tooling that team builds with — the same split, most days.",
