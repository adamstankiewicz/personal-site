...
export const experiences: ExperienceItemProps[] = [
    ...
    },
    {
      ...
      description: "Shipped reusable Ractive.js components for a B2B web application, partnering directly with a designer and a product manager. Revamped the dashboard with fuzzy search, venue filtering, and CSV export, and built the real-time social data ingestion behind it.",
      technologies: [
